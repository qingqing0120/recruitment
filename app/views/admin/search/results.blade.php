...
<tr>
    ...
    <td >{{ Form::select('status', array(0 => 'Please wait for the response', 1 => 'Reject', 2 => 'Waitlist', 3 => 'Receive'), $apstatus, array('id' => 'statusfor'.$appid, 'onChange' => "updateStat($appid)")) }}</td>
    <td >
    {{ Form::close() }}
