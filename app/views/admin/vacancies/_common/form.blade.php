...
<div class="form-group">
        ...
        <div class="col-lg-10">
        {{ Form::text('open_date', null, array('class' => 'form-control datepicker', 'placeholder' => 'Opening Date', 'id' => 'datepicker')) }}
        </div>
...
<div class="form-group">
        ...
        <div class="col-lg-10">
        {{ Form::text('closing_date', null, array('class' => 'form-control datepicker', 'placeholder' => 'Closing Date', 'id' => 'datepicker1')) }}
        </div>
