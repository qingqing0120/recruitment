...
@foreach($applicants as $applicant)
    ...
    <tr>
        ...
        <td>
        {{ Form::select('status', array(0 => 'Please wait for the response', 1 => 'Reject', 2 => 'Waitlist', 3 => 'Receive'), $applicant->status, array('id' => 'statusfor'.$applicant->id, 'onChange' => "updateStat($applicant->id)")) }}
        </td>
        <td>
        {{ Form::close() }}
